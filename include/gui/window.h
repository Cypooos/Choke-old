#ifndef __GENOS__GUI__WINDOWS_H
#define __GENOS__GUI__WINDOWS_H
...
namespace GenOS
{
  namespace gui
  {
    ...
    public:
      ...
      void OnMouseEnter(common::int32_t oldx,common::int32_t oldy,common::int32_t newx,common::int32_t newy);
      void OnMouseLeave(common::int32_t oldx,common::int32_t oldy,common::int32_t newx,common::int32_t newy);
